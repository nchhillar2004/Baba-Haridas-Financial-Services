...
function page() {
    ...
    useEffect(() => {
        ...
        try {
            ...
            console.log("Error in /app/posts/page.jsx");
        }
    }, []);
                ...
                <div className="posts-section flex justify-between w-full">
                    ...
                    <div className="posts-right w-2/6 px-8">
                        <PostAds
                            ...
                            image="https://upload.wikimedia.org/wikipedia/en/thumb/4/41/Flag_of_India.svg/800px-Flag_of_India.svg.png?20230723002237"
                            width="40"
                            right="0.00 INR"
                        />
                        <PostAds
                            ...
                            href="https://google.com"
                            width="40"
                            right="Register to get latest updates"
                        />
                        <div className="embedded flex items-center justify-center pb-2 my-2">
                            <iframe
                                width="320"
                                height="190"
                                src="https://www.youtube.com/embed/8CPGf0K7hJU"
                        ...
                        <PostAds
                            ...
                            href="https://google.com"
                            width="40"
                            right="Report an issue or a post"
                        />
                    </div>
                </div>
            </Layout>
